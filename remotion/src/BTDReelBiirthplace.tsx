...
export const BTDReelBiirthplace: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: bgColor, fontFamily: "'Inter', sans-serif", overflow: 'hidden' }}>
      ...
      <Sequence from={0}>
        <Audio src={staticFile('bp-mixed-audio.mp3')}
          volume={(f) => {
      ...
      <AbsoluteFill style={{ opacity: b2Opacity, zIndex: 10, padding: '0 60px', justifyContent: 'center' }}>
        {/* No country outline for Biirthplace — location unknown */}
        <div>
        ...
        <AbsoluteFill style={{ opacity: b3Opacity, zIndex: 10 }}>
          ...
          {visualMode === 'video' && (
            <div style={{
              ...
              <Video src={staticFile('biirthplace-clip.mp4')}
          ...
          {visualMode === 'reveal' && (
            <div style={{ position: 'absolute', inset: 0, overflow: 'hidden' }}>
              <div style={{
                ...
                <Img src={staticFile('biirthplace-hero.jpg')}
      ...
      <AbsoluteFill style={{ opacity: b5Opacity, zIndex: 10, padding: '0 70px', justifyContent: 'center' }}>
        <div>
          ...
          {[
            { num: '670K', label: 'Total Streams', delay: 517 },
            { num: '30K', label: 'Monthly Listeners', delay: 523 },
            { num: '1.8K', label: 'Instagram', delay: 529 },
            { num: '509K', label: 'Top Feature', delay: 535 },
            { num: '4', label: 'Solo Releases', delay: 541 },
            { num: '8', label: 'Posts on IG', delay: 547 },
          ].map((stat, si) => {
            ...
            return (
              <>
                ...
                <div style={{
                  ...
                  <Img src={staticFile('biirthplace-iddk-art-hires.jpg')} style={{
      ...
      {(() => {
        const captions: Array<{ text: string; start: number; end: number }> = [
          ...
          // Beat 2: "Meet Biirthplace. Producer, artist, and completely under the radar."
          { text: 'Meet Biirthplace.', start: 62, end: 90 },
          { text: 'Producer, artist, and completely', start: 90, end: 125 },
          { text: 'under the radar.', start: 125, end: 150 },
          // Beat 3 (over video): "500K streams on features. Four solo releases. And he is just getting started."
          { text: '500K streams on features.', start: 164, end: 205 },
          { text: 'Four solo releases.', start: 205, end: 240 },
          { text: 'And he is just', start: 240, end: 270 },
          { text: 'getting started.', start: 270, end: 313 },
          // Beat 5 (data): "30K monthly listeners. Under 2K Instagram followers. No label. No big features. Just music."
          { text: '30K monthly listeners.', start: 510, end: 548 },
          { text: 'Under 2K Instagram followers.', start: 548, end: 585 },
          { text: 'No label. No big features.', start: 585, end: 620 },
          { text: 'Just music.', start: 620, end: 660 },
          // CTA: "Go stream iDDK right now."
          { text: 'Go stream iDDK', start: 668, end: 705 },
